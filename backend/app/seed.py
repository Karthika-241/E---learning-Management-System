...
def seed(db: Session):
    ...
    students = [
        ...
        models.User(
            name="Dharshana ", role="student", avatar_emoji="🙋‍♀️", headline=""
        ),
        models.User(
            name="Arjun Iyer", role="student", avatar_emoji="🙋‍♂️", headline=""
        ),
    ]
    ...
    course_defs = [
        ...
        dict(
            ...
            level="Intermediate",
            price=799.0,
            thumbnail_seed="ml-course",
            category=cat["data-science-ai"],
        ...
        dict(
            title="React & FastAPI: Full-Stack Web Development",
            ...
            level="Intermediate",
            price=899.0,
            thumbnail_seed="fullstack-course",
            category=cat["development"],
            instructor=instructors[1],
            sections=[
                (
        ...
        dict(
            title="Data Science & AI Career Roadmap 2026",
        ...
        dict(
            ...
            level="Beginner",
            price=349.0,
            thumbnail_seed="speaking-course",
        ...
        dict(
            title="Startup Finance & Business Fundamentals",
            ...
            level="Intermediate",
            price=549.0,
            thumbnail_seed="business-course",
        ...
        dict(
            ...
            level="Advanced",
            price=999.0,
            thumbnail_seed="advanced-react-course",
            category=cat["development"],
            instructor=instructors[1],
            sections=[
                (
    ...
    for i, cdef in enumerate(course_defs):
        course = models.Course(
            ...
            level=cdef["level"],
            price=cdef["price"],
            thumbnail_seed=cdef["thumbnail_seed"],
            language="English",
            category=cdef["category"],
            instructor=cdef["instructor"],
            ...
            for l_idx, (lec_title, dur, is_preview) in enumerate(lectures):
                section.lectures.append(
                    models.Lecture(
                        ...
                        video_url=(
                            SAMPLE_VIDEO if (s_idx + l_idx) % 2 == 0 else SAMPLE_VIDEO_2
                        ),
                    )
                )
    ...
    question_pool = {
        "development": [
            ...
            (
                "Which operator is used for equality check in JavaScript?",
                "=",
                "==",
                "===",
                "!=",
        ...
        "data-science-ai": [
            ...
            (
                ...
                "Model performs well everywhere",
                "Model is too simple",
                "Model has no errors",
                "a",
            ),
            ...
            (
                "Which metric is used for classification?",
                "Mean Squared Error",
                "Accuracy",
                "R-squared",
                "Standard deviation",
            ...
            (
                ...
                "A table describing model performance",
                "A type of neural network",
            ...
            (
                ...
                "A model parameter learned from data",
            ...
            (
                "What is a dataset split used for?",
            ...
            (
                ...
                "Data used for feature engineering",
                "All available data",
                "b",
            ),
        ],
        "design": [
            (
                ...
                "Universal X-ray design",
                "Ultra eXtreme design",
                "Unified XHTML design",
                "a",
            ),
            (
            ...
            (
                "Which tool is popular for UI design?",
                "Excel",
                "Figma",
                "Word",
                "Chrome",
            ...
            (
                ...
                "The study of how colors mix in paint",
                "The science of how colors affect perception",
            ...
            (
                ...
                "An interactive mockup of a product",
                "A database schema",
            ...
            (
                ...
                "How well a design adapts to screen sizes",
                "How colorful a page is",
                "How many fonts are used",
                "b",
            ),
            (
            ...
            (
                ...
                "Making designs usable for people with disabilities",
                "Making designs fast to load",
            ...
            (
                ...
                "Building computer architecture",
                "Network design",
                "Database design",
                "a",
            ),
            (
                ...
                "A collection of design inspirations",
                "A type of whiteboard",
                "A code editor",
                "A prototyping tool",
                "a",
            ),
            ...
            (
                ...
                "A prompt for user to take action",
                "A phone call",
                "A type of animation",
                "A database query",
                "a",
            ...
            (
                ...
                "Difference between elements that makes them stand out",
                "A type of font",
                "A color",
                "An image filter",
                "a",
            ...
            (
                ...
                "A document of design standards",
            ...
            (
                ...
                "A mathematical ratio used in design",
                "A programming ratio",
                "A database ratio",
                "A network ratio",
                "a",
            ...
            (
                "What is an iteration in design?",
                "A repeated cycle of improvement",
                "A single design",
                "A final product",
                "A meeting",
                "a",
        ...
        "business": [
            ...
            (
                ...
                "Gathering information about target markets",
            ...
            (
                ...
                "Something that sets a business apart",
                "A type of discount",
                "An employee benefit",
                "A tax deduction",
                "a",
            ...
            (
                ...
                "The unique value a product offers",
            ...
            (
                ...
                "The intended group of customers",
                "Company employees",
                "Board members",
                "Suppliers",
                "a",
            ...
            (
                "What is an investor?",
                "Someone who provides capital for returns",
                "A type of employee",
                "A customer",
                "A supplier",
                "a",
        ...
        "personal-development": [
            ...
            (
                ...
                "Planning how to use time effectively",
                "Watching time pass",
                "Working all day",
                "A clock",
                "a",
            ...
            (
                "What is a priority?",
                "Something ranked as more important",
                "A type of task",
                "A schedule",
                "A deadline",
                "a",
            ...
            (
                ...
                "Examining your own thoughts and actions",
                "Looking in a mirror",
                "Reading a book",
                "Writing a report",
                "a",
            ...
            (
                "What is a mentor?",
                "Someone who guides your development",
                "A type of teacher",
                "A manager",
                "A friend",
                "a",
            ...
            (
                ...
                "A professional objective to achieve",
                "A daily task",
                "A hobby",
                "A vacation plan",
                "a",
            ...
            (
                ...
                "Ability to control impulses and stay focused",
                "A personality trait",
            ...
            (
                "What is a routine?",
                "A regular sequence of activities",
                "A one-time event",
                "A type of exercise",
                "A diet plan",
                "a",
            ...
            (
                "What is well-being?",
                "State of being comfortable and healthy",
                "Wealth",
                "Fame",
                "Popularity",
                "a",
    ...
    for course in all_courses:
        ...
        if cat_slug == "development":
            pool_key = "development"
        elif cat_slug == "data-science-ai":
            pool_key = "data-science-ai"
        elif cat_slug == "design":
            pool_key = "design"
        elif cat_slug == "business":
            pool_key = "business"
        else:
